...
from ml_models import LSTMQuotaPredictor, NSGA3QuotaOptimizer, predict_and_optimize_quota
...
def test_lstm_predictor():
    ...
    lstm = LSTMQuotaPredictor(lookback_months=3, hidden_size=20, epochs=10)
